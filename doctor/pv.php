        ...
        <div class="form-card">
            <?php if($patient): ?>
                            ...
                            <td>
                                <div class="patient-profile-section">
                                    ...
                                    <div class="patient-info">
                                        <span class="patient-name"><?php echo htmlspecialchars($patient['pname']); ?></span>
                                        <span class="patient-id">P-<?php echo $patient['pid']; ?></span>
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                <table class="appointment-table">
                    ...
                    <tbody>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-envelope"></i> Email:</strong></td>
                            <td><?php echo htmlspecialchars($patient['pemail']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-phone"></i> Phone:</strong></td>
                            <td><?php echo htmlspecialchars($patient['ptel']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-birthday-cake"></i> Date of Birth:</strong></td>
                            <td><?php echo htmlspecialchars($patient['pdob']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-id-card"></i> NIC:</strong></td>
                            <td><?php echo htmlspecialchars($patient['pnic']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-venus-mars"></i> Gender:</strong></td>
                            <td><?php echo htmlspecialchars($patient['gender'] ?? 'Not specified'); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-home"></i> Address:</strong></td>
                ...
                <table class="appointment-table">
                    ...
                    <tbody>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-tint"></i> Blood Type:</strong></td>
                            <td><?php echo htmlspecialchars($patient['blood_type'] ?? 'Not specified'); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-allergies"></i> Allergies:</strong></td>
                            <td><?php echo htmlspecialchars($patient['allergies'] ?? 'None'); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-procedures"></i> Chronic Conditions:</strong></td>
                            <td><?php echo htmlspecialchars($patient['chronic_conditions'] ?? 'None'); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong><i class="fas fa-pills"></i> Medications:</strong></td>
                    ...
                    <thead>
                        <tr>
                            <th colspan="3" class="table-header">
                                <i class="fas fa-calendar-check"></i> Appointments History
                            </th>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php if(count($completed_appointments) > 0): ?>
                                    ...
                                    <div class="report-card">
                                        ...
                                        <div class="report-field">
                                            <span class="report-label"><i class="fas fa-diagnoses"></i> Diagnosis:</span>
                                            <span class="report-value"><?php echo htmlspecialchars($appointment['diagnosis']); ?></span>
                                        </div>
                                        <?php endif; ?>
                                        
                                        <?php if($appointment['treatment']): ?>
                                        <div class="report-field">
                                            <span class="report-label"><i class="fas fa-prescription-bottle-alt"></i> Treatment:</span>
                                            <span class="report-value"><?php echo nl2br(htmlspecialchars($appointment['treatment'])); ?></span>
                                        </div>
                                        <?php endif; ?>
                                        
                                        <?php if($appointment['report']): ?>
                                        <div class="report-field">
                                            <span class="report-label"><i class="fas fa-file-alt"></i> Report:</span>
                                            <span class="report-value"><?php echo nl2br(htmlspecialchars($appointment['report'])); ?></span>
                                        </div>
                                        <?php endif; ?>
                                        
                                        <?php if($appointment['followup_date']): ?>
                                        <div class="report-field">
                                            <span class="report-label"><i class="fas fa-calendar-plus"></i> Follow-up Date:</span>
                                            <span class="report-value"><?php echo htmlspecialchars($appointment['followup_date']); ?></span>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <div class="no-data-cell">
                                        <i class="fas fa-file-medical-alt"></i> No medical reports available for this patient.
                                    </div>
                                <?php endif; ?>
                            </td>
                        </tr>
