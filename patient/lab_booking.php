                ...
                <div class="booking-details-container">
                    <div class="booking-card">
                        <div class="booking-header">
                            <i class="fas fa-flask booking-icon"></i>
                            <h2>Lab Test Details</h2>
                        </div>
                        <div class="booking-content">
                            <div class="booking-row">
                                <span class="booking-label">Test Name:</span>
                                <span class="booking-value"><?php echo $labname; ?></span>
                            </div>
                            <div class="booking-row">
                            ...
                            <div class="booking-row">
                                ...
                                <span class="booking-value highlight">EGP <?php echo $price; ?></span>
                            </div>
