...
<div class="container">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            echo '
            <div id="popup1" class="overlay">
                <div class="popup profile-popup" style="width: 70%;">
                    <center>
                        ...
                        <div class="content">
                            <div class="profile-view">
                                ...
                                <div class="profile-details">
                                    ...
                                    <div class="detail-item">
                                        <span class="detail-label"><i class="fas fa-phone"></i> Telephone:</span>
                                        <span class="detail-value">'.htmlspecialchars($tele).'</span>
                                    </div>
                                    <div class="detail-item">
                                        <span class="detail-label"><i class="fas fa-star"></i> Specialties:</span>
                                        <span class="detail-value">'.htmlspecialchars($spcil_name).'</span>
                                    </div>
                                </div>
            ...
            if($error_1!='4'){
                echo '
                <div id="popup1" class="overlay">
                    <div class="popup edit-popup" style="width: 70%;">
                        <center>
                            <h2>Edit Doctor Details</h2>
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                '.$errorlist[$error_1].'
                                <form action="edit-doc.php" method="POST" class="edit-form">
                                    ...
                                    <div class="form-group">
                                        <label for="spec">Specialties (Current: '.htmlspecialchars($spcil_name).')</label>
