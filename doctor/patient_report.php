...
<div class="container">
    <div class="menu" id="sidebarMenu">
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td colspan="2">
                    <a href="patient_report.php" class="non-style-link-menu non-style-link-menu-active">
    ...
    <div class="nav-bar animate-slide-up">
        ...
        <div>
            <p class="header-title">Patient Report</p>
        </div>
    ...
    <div class="form-main-container">
        <div class="form-card">
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="table-header">
                                <i class="fas fa-file-medical"></i> Report for <?php echo htmlspecialchars($patient_details['pname']); ?>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="label-cell"><strong>Patient ID:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['pid']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>Name:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['pname']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>Email:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['pemail']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>NIC:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['pnic']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>Telephone:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['ptel']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>Date of Birth:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['pdob']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>Address:</strong></td>
                            <td><?php echo htmlspecialchars($patient_details['paddress']); ?></td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <thead>
                        <tr>
                            <th class="table-header">
                                <i class="fas fa-clipboard-list"></i> Medical Report
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <div class="report-content">
                                    <p>This section will contain the specific medical report data for <?php echo htmlspecialchars($patient_details['pname']); ?>.</p>
                                    <!-- يمكن إضافة المزيد من تفاصيل التقرير هنا -->
                                </div>
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <tr>
                            <td class="report-footer">
                                <div class="footer-content">
                                    <img src="../img/seal.png" alt="Opticare Hospital" class="seal-image">
                                    <p class="generation-date">
                                        <i class="fas fa-calendar-alt"></i> Report generated on: <?php echo date('Y-m-d H:i:s'); ?>
                                    </p>
                                </div>
                            </td>
                        </tr>
            ...
            <?php else: ?>
                <!-- No Patient Found Section -->
                <table class="appointment-table">
                    <tbody>
                        <tr>
                            <td class="no-data-cell">
                                <div class="no-patient-found">
                                    <i class="fas fa-exclamation-circle"></i>
                                    <h3>Patient Not Found</h3>
                                    <p>Please select a patient to view their report.</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
