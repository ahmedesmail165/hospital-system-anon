...
if($_POST){
    if(isset($_POST["search"])){
        ...
        $sqlmain= "select DISTINCT patient.* from patient where pemail='$keyword' or pname='$keyword' or pname like '$keyword%' or pname like '%$keyword' or pname like '%$keyword%' ";
        $selecttype="my";
    }
    ...
    <div class="nav-bar animate-slide-up">
        ...
        <div style="display: flex; justify-content: center; align-items: center; flex-grow: 1;">
            <form action="" method="post" class="header-search" style="display: flex; align-items: center; gap: 10px;">
                ...
                echo '</datalist>';
                ?>
                <input type="Submit" value="Search" name="search" class="btn-primary btn" style="padding: 10px 25px;">
            </form>
        </div>
    ...
    <div class="filter-container animate-slide-up">
        <form action="" method="post">
            <table border="0" width="100%">
                <tr>
                    <td width="10%" style="text-align: right;">Show Details About : &nbsp;</td>
                    <td width="30%">
                        <select name="showonly" class="filter-container-items" style="width:90%;">
                    ...
                    if($result->num_rows==0){
                            ...
                            <td colspan="6">
                                ...
                                <center>
                                    ...
                                    <a class="non-style-link" href="patient.php">
                                        <button class="btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Patients &nbsp;</button>
                                    </a>
                                </center>
                                <br><br><br><br>
                            </td>
                        ...
                        while($row=$result->fetch_assoc()){
                            ...
                            echo '<tr>
                                ...
                                <td>'.htmlspecialchars(substr($nic,0,12)).'</td>
                                ...
                                <td>
                                    <div style="display:flex;justify-content: center;gap:10px;">
                                        <a href="pv.php?id='.$pid.'" class="non-style-link"><button class="btn-view">View</button></a>
                                        <a href="patient_report.php?id='.$pid.'" class="non-style-link"><button class="btn-view">View Report</button></a>
                                    </div>
                                </td>
                            </tr>';
                        }
                ...
                <div class="content">
                    <div style="display: flex;justify-content: center;">
                        <table width="80%" class="sub-table add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="patient.php"><button class="btn-primary btn">OK</button></a>
                                </td>
                            </tr>
                        </table>
                    </div>
