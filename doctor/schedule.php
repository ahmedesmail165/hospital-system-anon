...
<div class="container">
    ...
    <i class="fas fa-arrow-left"></i> Back
        ...
        <div>
            <p class="header-title">My Sessions</p>
        </div>
                                    ...
                                    <td>
                                        <div style="display:flex;justify-content: center;gap:10px;">
                                            ...
                                            <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link">
                                                <button class="btn-delete">Cancel Session</button>
                                            </a>
                                        </div>
                                    </td>
                                </tr>';
    ...
    if($action == 'drop'){
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <div style="display: flex;justify-content: center;gap:10px;">
                    <a href="delete-session.php?id='.$id.'" class="non-style-link"><button class="btn-primary btn">Yes</button></a>
                    <a href="schedule.php" class="non-style-link"><button class="btn-primary btn">No</button></a>
                    </div>
                </center>
        </div>
        </div>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <a class="close" href="schedule.php">&times;</a>
                    <div class="content">
                        <div class="scroll" style="display: flex;justify-content: center;">
                ...
                if($result->num_rows == 0) {
                    ...
                    <img src="../img/notfound.svg" width="25%">
                    <br>
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No patients registered yet!</p>
                    </center>
                    <br><br><br><br>
                    </td>
                    </tr>';
