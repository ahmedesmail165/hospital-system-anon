...
<body>
  ...
  <div class="container">
    ...
    <i class="fas fa-arrow-left"></i> Back
        ...
        <div>
            <p class="header-title">Session Search</p>
        </div>
        ...
        <div class="filter-container animate-slide-up">
            <form action="" method="post" class="header-search">
                <table border="0" width="100%">
                    <tr>
                        <td width="80%">
                            <input type="search" name="search" class="filter-container-items" placeholder="Search Doctor name or Email or Date (YYYY-MM-DD)" list="doctors" value="<?php echo $insertkey ?>">
                ...
                if($result->num_rows==0){
                    echo '<div class="no-results">
                        <center>
                            ...
                            <a class="non-style-link" href="schedule.php"><button class="btn-primary" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">Show all Sessions</button></a>
                        </center>
                    </div>';
                } else {
                    ...
                    for ($x=0; $x<($result->num_rows);$x++){
                        ...
                        echo '<div class="session-card">
                            ...
                            <div class="session-body">
                                <p><i class="fas fa-user-md"></i> '.substr($docname,0,30).'</p>
                                <p><i class="far fa-calendar-alt"></i> '.$scheduledate.'</p>
                                <p><i class="far fa-clock"></i> Starts: @'.substr($scheduletime,0,5).' (24h)</p>
                            </div>
