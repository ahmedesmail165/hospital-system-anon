...
<div class="dash-body">
    <div class="nav-bar animate-slide-up">
        ...
        <div>
            <p class="header-title">My Completed Bookings</p>
        </div>
    ...
    <div class="table-container animate-slide-up">
        <p class="table-title">
            ...
            My Completed Bookings (<?php echo $result->num_rows; ?>)
        </p>
        ...
        <center>
            <div class="abc scroll">
                <table width="93%" class="sub-table scrolldown" border="0">
                    <thead>
                        <tr>
                            <th class="table-headin">Ref. No</th>
                        ...
                        if($result->num_rows == 0) {
                            echo '<tr><td colspan="7" class="no-results">
                                    <center>
                                        ...
                                        <a class="non-style-link" href="appointment.php">
                                            <button class="btn-primary" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">
                            ...
                            for ($x=0; $x<($result->num_rows); $x++) {
                                ...
                                echo '<tr>
                                        ...
                                        <td>'.substr($title,0,21).'</td>
                                        <td>'.$scheduledate.' '.substr($scheduletime,0,5).'</td>
                                        <td><span class="status-badge '.$status_class.'">'.ucfirst($status).'</span></td>
                                        <td>
                                            <a href="sform.php?doctor='.$docname.'" class="non-style-link">
    ...
    if($action=='booking-added'){
        ...
        <div id="popup1" class="overlay">
                ...
                <br><br>
                    ...
                    <a href="appointment.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;">OK</button></a>
                    <br><br><br><br>
                    </div>
                </center>
        </div>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <div style="display: flex;justify-content: center;">
                    <a href="delete-appointment.php?doctor='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;">Yes</button></a>&nbsp;&nbsp;&nbsp;
