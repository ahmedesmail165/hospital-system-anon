...
<div class="container">
    ...
    <div class="nav-bar animate-slide-up">
        <div>
            <a href="radio.php" class="non-style-link">
                ...
                <div class="booking-details-container">
                    <div class="booking-card">
                        <div class="booking-header">
                            <i class="fas fa-x-ray booking-icon"></i>
                            <h2>Radiology Session Details 
                                <span class="session-badge <?php echo $badge_class; ?>"><?php echo strtoupper($session_type); ?></span>
                            </h2>
                        </div>
                        <div class="booking-content">
                            <div class="booking-row">
                                <span class="booking-label">Technician:</span>
                                <span class="booking-value"><?php echo $techname; ?></span>
                            </div>
                            <div class="booking-row">
                                <span class="booking-label">Email:</span>
                                <span class="booking-value"><?php echo $techemail; ?></span>
                            </div>
                            <div class="booking-row">
                            ...
                            <div class="booking-row">
                                ...
                                <span class="booking-value"><?php echo substr($scheduletime,0,5); ?></span>
                            </div>
                            <div class="booking-row">
                                <span class="booking-label">Duration:</span>
                                <span class="booking-value"><?php echo $duration; ?> minutes</span>
                            </div>
                            <div class="booking-row">
                                <span class="booking-label">Fee:</span>
                                <span class="booking-value highlight"><?php echo $fee; ?></span>
                            </div>
                            <div class="booking-row full-width">
