...
// جلب بيانات المريض إذا كان هناك معرف مريض في الرابط
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['patient_id']) && isset($_POST['specialty_id'])) {
    ...
    // هنا يمكنك إضافة الكود لحفظ التخصص المختار للمريض
    // مثلاً تحديث سجل المريض أو إنشاء سجل جديد في جدول مرجعي
    
    $_SESSION['success_message'] = "تم تعيين التخصص بنجاح للمريض";
...
<div class="container">
    ...
    <div class="nav-bar animate-slide-up">
        ...
        <div>
            <p class="header-title">Assign Specialty</p>
        </div>
                ...
                <table class="appointment-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($patientData['pname']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>ID:</strong></td>
                            <td><?php echo htmlspecialchars($patientData['pid']); ?></td>
                        </tr>
                        <tr>
                            <td class="label-cell"><strong>Email:</strong></td>
                            <td><?php echo htmlspecialchars($patientData['pemail']); ?></td>
                        </tr>
                    </tbody>
                </table>
            <?php endif; ?>
            
            <form method="post" action="assign-specialty.php" class="medical-form">
                ...
                <table class="report-table">
                    <thead>
                        <tr>
                            <th colspan="2" class="table-header">
                                <i class="fas fa-user-md"></i> Assign Medical Specialty
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="label-cell">
                                <label for="specialty_id"><i class="fas fa-stethoscope"></i> Medical Specialty:</label>
                            </td>
                            <td>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Assign Specialty
                    </button>
                </div>
            </form>
        </div>
