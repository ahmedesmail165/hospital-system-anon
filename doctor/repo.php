...
<div class="container">
    <div class="menu" id="sidebarMenu">
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td colspan="2">
                    <a href="repo.php" class="non-style-link-menu non-style-link-menu-active">
    ...
    <div class="nav-bar animate-slide-up">
        ...
        <div>
            <p class="header-title">Treated Patients</p>
        </div>
            ...
            <table class="sub-table" border="0">
                <thead>
                    <tr>
                        ...
                        <th class="table-headin">Report</th>
                    ...
                    if($donePatientsResult->num_rows == 0) {
                        ...
                        while($row = $donePatientsResult->fetch_assoc()) {
                            echo '<tr>
                                ...
                                <td>'.htmlspecialchars($row['scheduledate']).' @ '.substr($row['scheduletime'], 0, 5).'</td>
                                <td>'.(!empty($row['report']) ? substr(htmlspecialchars($row['report']), 0, 50).'...' : 'No report').'</td>
                                <td>
                                    <div style="display:flex;justify-content: center;gap:10px;">
                                        <a href="add-report.php?appoid='.$row['appoid'].'" class="non-style-link">
                                            <button class="btn-view">'.(!empty($row['report']) ? 'Edit Report' : 'Add Report').'</button>
                                        </a>
                                        <a href="pv.php?id='.$row['pid'].'" class="non-style-link">
                                            <button class="btn-view">View Patient</button>
                                        </a>
                                        <a href="reco.php?patient_id='.$row['pid'].'" class="non-style-link">
                                            <button class="btn-view">Assign Specialty</button>
                                        </a>
                                        <a href="upload-pdf.php?appoid='.$row['appoid'].'" class="non-style-link">
                                            <button class="btn-view">Upload PDF</button>
                                        </a>
                                    </div>
                                </td>
                            </tr>';
