...
<body>
    ...
    <i class="fas fa-arrow-left"></i> Back
        ...
        <div>
            <p class="header-title">Medical Lab Tests</p>
        </div>
        ...
        <div class="filter-container animate-slide-up">
            <form action="" method="post" class="header-search">
                <table border="0" width="100%">
                    <tr>
                        <td width="80%">
                            <input type="search" name="search" class="filter-container-items" placeholder="Search Lab Test by Name" list="labtests">
                            
                            <?php
                            echo '<datalist id="labtests">';
                            $list = $database->query("SELECT DISTINCT name FROM lab_types WHERE is_active=1");
                        ...
                        if($result->num_rows == 0) {
                            echo '<tr><td colspan="6" class="no-results">
                                    <center>
                                        ...
                                        <br>
                                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No lab tests available at the moment!</p>
                                    </center>
                                </td></tr>';
                        } else {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="lab_schedule.php?type='.$row["lab_type_id"].'">
                                            <button class="btn-primary btn-icon-back">View Schedule</button>
                                        </a>
                                    </td>
                                </tr>';
                            }
