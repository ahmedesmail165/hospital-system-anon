...
<body>
    ...
    <i class="fas fa-arrow-left"></i> Back
                ...
                <div>
                    <p class="header-title">Schedule Manager</p>
                </div>
                ...
                <div class="filter-container animate-slide-up">
                    <form action="" method="post">
                        <table border="0" width="100%">
                            <tr>
                                <td width="5%" style="text-align: right; padding-right: 10px;">Date:</td>
                                <td width="30%">
                                    <input type="date" name="sheduledate" id="date" class="filter-container-items" style="width: 95%;">
                                </td>
                                <td width="5%" style="text-align: right; padding-right: 10px;">Doctor:</td>
                                <td width="30%">
                                    <select name="docid" id="" class="filter-container-items" style="width: 95%;">
                        ...
                        <tbody>
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="schedule.php"><button class="btn-primary" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">Show all Sessions</button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                <div class="popup" style="width: 70%; position: relative;">
                    <center>
                        <button class="close" style="position: absolute; top: 15px; right: 15px; background: none; border: none; font-size: 24px; color: #666; cursor: pointer; z-index: 1000;" onclick="window.location.href=\'schedule.php\'">&times;</button>
                        <div class="content"></div>
                        <div class="abc scroll" style="display: flex;justify-content: center;">
                            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                <tr>
                                    <td>
                                        <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New Session</p><br><br>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <select name="docid" id="" class="box" required style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid #ddd; background: white; color: #333; font-size: 14px;">
                                            <option value="" disabled selected hidden style="color: #666;">Choose Doctor Name from the list</option>';
                                        ...
                                        for ($y=0;$y<$list11->num_rows;$y++){
                                            ...
                                            $sn=$row00["docname"];
                                            $id00=$row00["docid"];
                                            echo "<option value=".$id00." style='color: #333;'>".$sn."</option>";
                                        };
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <input type="number" name="nop" class="input-text" min="0" placeholder="The final appointment number for this session depends on this number" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div style="display: flex; justify-content: center; gap: 20px; margin-top: 20px;">
                                            <input type="reset" value="Reset" class="btn-primary btn-icon-back" style="padding: 10px 20px;">
                                            <input type="submit" value="Add Session" class="btn-primary btn" name="shedulesubmit" style="padding: 10px 20px;">
                                        </div>
                                    </td>
                                </tr>
                            </form>
