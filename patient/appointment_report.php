...
<body>
    ...
    <div class="nav-bar animate-slide-up">
        ...
        <div>
            <p class="header-title">Appointment Reports</p>
        </div>
        ...
        <center>
            <div class="abc scroll">
                <table width="93%" class="sub-table scrolldown" border="0">
                    ...
                    <tbody>
                        <?php
                        $sqlmain = "SELECT a.*, s.title, s.scheduledate, s.scheduletime, d.docname 
                                  FROM appointment a 
                        ...
                        if($result->num_rows == 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo '<tr>
                                        ...
                                        <td>
                                            <button class="btn-primary btn-icon-back view-details-btn" data-appointment=\''.json_encode($row).'\'>
                                                View Details
                                            </button>
                                        </td>
                                    </tr>';
...
<div id="appointmentModal" class="modal">
    <div class="modal-content">
        ...
        <div id="modalAppointmentDetails"></div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalContent = document.getElementById('modalAppointmentDetails');
   ...
   function showAppointmentDetails(appointment) {
        let html = `
            <div class="report-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2 style="color: #4a6fa5;">Appointment #${appointment.apponum}</h2>
            </div>
            
            <div class="report-details">
                <h3 style="color: #4a6fa5; border-bottom: 1px solid #eee; padding-bottom: 10px;">
                ...
                <div class="detail-row">
                    ...
                    <div>
                        ...
                        <span class="detail-value">${appointment.docname}</span>
                        <div class="status-badge status-${appointment.status.toLowerCase()}" style="margin-top: 5px;">
                            <i class="fas ${appointment.status === 'done' ? 'fa-check-circle' : 'fa-clock'}"></i>
                ...
                <div class="detail-row">
                    ...
                    <div>
                        ...
                        <span class="detail-value">${appointment.scheduledate}</span>
                    </div>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <div>
                        ...
                        <span class="detail-value">${appointment.scheduletime.substring(0, 5)}</span>
                    </div>
                </div>`;
        
        if (appointment.status === 'done') {
            html += `
                <h3 style="color: #4a6fa5; border-bottom: 1px solid #eee; padding-bottom: 10px; margin-top: 20px;">
                ...
                html += `
                    <div class="detail-row">
                        ...
                        <div>
                            ...
                            <span class="detail-value">${appointment.report}</span>
                        </div>
                    </div>`;
            }
            ...
            if (appointment.diagnosis) {
                html += `
                    <div class="detail-row">
                        <i class="fas fa-diagnoses detail-icon"></i>
                        <div>
            ...
            if (appointment.treatment) {
                html += `
                    <div class="detail-row">
                        <i class="fas fa-prescription-bottle-alt detail-icon"></i>
                        <div>
            ...
            if (appointment.pdf_report) {
                html += `
                    <div class="report-action">
                        <a href="../uploads/reports/${appointment.pdf_report}" target="_blank" class="btn-primary btn">
...
// Add error handling for PDF downloads
document.addEventListener('click', function(e) {
    if (e.target.closest('.report-action a')) {
        e.preventDefault();
        const link = e.target.closest('.report-action a');
        ...
        fetch(pdfPath)
            .then(response => {
                if (response.ok) {
                    ...
                    alert('Sorry, the report file is not available at the moment.');
                }
            })
            .catch(error => {
                console.error('Error checking PDF:', error);
                alert('Sorry, there was an error accessing the report. Please try again later.');
            });
    }
});
</script>