...
<body>
   ...
   <div class="container">
    ...
    <div class="nav-bar animate-slide-up">
        ...
        <div>
            <p class="header-title">Radiology Search</p>
        </div>
        ...
        <div class="filter-container animate-slide-up">
            <form action="" method="post" class="header-search">
                <table border="0" width="100%">
                    <tr>
                        <td width="80%">
                            <input type="search" name="search" class="filter-container-items" placeholder="Search Radiology Type or Date" list="radiology" value="<?php echo isset($_POST['search']) ? $_POST['search'] : '' ?>">
                        ...
                        <td width="20%">
                            <input type="Submit" value="Search" class="btn-primary" style="width:100%;">
                        </td>
                    </tr>
                </table>
            </form>
            ...
            if($result->num_rows==0){
                echo '<div class="no-results">
                    <center>
                        ...
                        <a class="non-style-link" href="radio.php"><button class="btn-primary" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">Show All Sessions</button></a>
                    </center>
                </div>';
            } else {
                ...
                for ($x=0; $x<($result->num_rows);$x++){
                    ...
                    echo '<div class="session-card">
                        ...
                        <div class="session-body">
                            <p><i class="far fa-clock"></i> Duration: '.$duration.' minutes</p>
                            <p><i class="far fa-calendar-alt"></i> '.$scheduledate.'</p>
                            <p><i class="fas fa-clock"></i> Starts: @'.substr($scheduletime,0,5).'</p>
                            <p class="preparation-text"><i class="fas fa-info-circle"></i> Preparation: '.substr($preparation,0,50).'...</p>
                        </div>
                        <div class="session-footer">
                            <a href="radbooking.php?id='.$scheduleid.'&type=radiology">
